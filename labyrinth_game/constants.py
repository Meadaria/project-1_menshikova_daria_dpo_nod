...
ROOMS = {
    ...
    'storeroom': {
          'description': 'Узкая кладовка, заваленная до потолка покрытыми пылью ящиками. Воздух спертый, пахнет затхлостью. В дальнем углу вдинеется странная запись.',
          'exits': {'norht': 'library', 'east' : 'entrance'},
          'items': ['brainteaser'],
          'puzzle': ('Кажется, это задачкаЖ  "Если три кошки ловят трех мышей за три минуты, сколько времени нужно одной кошке чтобы поймать одну мышь?"', '3')
    },
     'dining_room': {
          'description': 'Просторная столовая с длинным дубовым столом. На столе - пыльная посуда и потускневшие канделябры. В воздухе витает запах старого воска.',
          'exits': { 'west' : 'hall'},
          'items': ['silver spoon'],
          'puzzle': ('На столе вырезано: "Какое число делится на все числа от 1 до 10?"', '2520')
    }
